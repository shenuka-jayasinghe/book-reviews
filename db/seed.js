...
exports.seed = () => {
  console.log('===========SEEDING DATABASE=========')
      return db.query(`
            DROP TABLE IF EXISTS my_bookshop CASCADE;
            CREATE TABLE my_bookshop ( 
        ...
        `)
    .then(() => {
      console.log(`table 'my_bookshop' created`);
      return db.query(`
...
VALUES
    ...
    ('Pride and Prejudice', 699, 4, '1813-01-28', true);
      ...
      .then(() => {
        console.log(`Book titles, prices, quantities, release dates and is fiction inserted`)
        return db.query(`
      ...
      .then(() => {
        console.log(`author fun facts inserted`)
        return db.query(`
      ...
      .then(() => {
        console.log(`authors fun facts data inserted`)
        return db.query(`
      ...
      .then(() => {
        console.log(`column 'author_id' inserted to authors table`)
        return db.query(`
  ...
  VALUES
      ...
      .then(() => {
        console.log('inserted genres and created book_genres table')
        return db.query(`
      ...
      .then(() => {
        console.log('joined my_bookshop to book_genres')
          return db.query(`
      ...
      .then(() => {
        console.log('inserted book reviews')
          return db.query(`
          ALTER TABLE my_bookshop
